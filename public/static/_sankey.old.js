...
angular.module('gSankey')
    ...
    var init = function ($scope, elem, attrs) {
        ...
        streamHandler.addHandler($scope.flow.name, function (data) {
            data.forEach(function (datum) {
                d3.selectAll("path.link")
                    .each(function (d) {
                    if (d.source.name !== datum.nodeName) {
                        return;
                    }
    ...
    return {
        ...
        link: function ($scope, elem, attrs) {
            $scope.$watch('flow.name', function (n) {
